...
private:
	...
	const std::time_t to_time_t(const TP& tp);
	bool isNumber(const std::string& s);
	const std::time_t getDateTimeFromString(const std::string& datetime);
	const std::string put(asio::ip::tcp::iostream& server, const std::string& path = "");
	void get(asio::ip::tcp::iostream& server);
	const std::string del(asio::ip::tcp::iostream& server, const std::string& path = "");
	const std::string ren(asio::ip::tcp::iostream& server);
	const std::vector<std::string> dir(asio::ip::tcp::iostream& server, const std::string& path = "");
	const std::string mkdir(asio::ip::tcp::iostream& server, const std::string& path = "");
